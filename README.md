...
medication can be developed. [This short video provides a brief overview of the way the experiments are conducted](https://youtu.be/mYz3KEDQDwQ). Crystallographic experiments are currently deducted
